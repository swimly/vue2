(function (global, factory) {
  ...
  var __vue_render__ = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("div", { staticClass: "m-button" }, [
      _c(
        "span",
        { staticClass: "m-button-icon" },
        [
          _vm._t("icon", function() {
            return [
              _vm.icon
                ? _c("m-icon", { attrs: { size: "14", name: _vm.icon } })
                : _vm._e()
            ]
          })
        ],
      ...
      _vm._v(" "),
      _c("span", { staticClass: "m-button-label" }, [
        _c(
          "span",
          [
  ...
  __vue_render__._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__ = "data-v-474db7b0";
    /* module identifier */
