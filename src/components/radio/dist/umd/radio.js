(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.radio = factory());
  ...
  var __vue_render__ = function() {
    ...
    return _c(
      "div",
      { staticClass: "m-radio", attrs: { fill: _vm.fill, stoke: _vm.stoke } },
      [
        _c("input", {
          staticClass: "m-radio-core",
          attrs: { type: "radio" },
          domProps: { checked: _vm.isCheck },
        ...
        _c(
          "span",
          {
            staticClass: "m-radio-frame",
            style: "width:" + _vm.size + "px;height:" + _vm.size + "px;"
          },
          [_c("m-icon", { attrs: { size: _vm.size * 0.8, name: _vm.icon } })],
          1
        ),
        _vm._v(" "),
        _c("span", { staticClass: "m-radio-label" }, [_vm._t("default")], 2)
      ]
    )
  };
  ...
  __vue_render__._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__ = "data-v-651c66c2";
    /* module identifier */
